...
export default function Sidebar(){
    ...
    return (
        <div className="sidebar-container flex-column-center"> 
            ...
            {
                indexContext.frameEight?.Frames.length === 0 && indexContext.frameSixteen?.Frames.length === 0 ? null :
                <>
                    <div className='flex-column-center'>
                    ...
                    <div className="">current cube {indexContext.IsEightByEight ? '8 by 8' : '16 by 16'}</div>
                    ...
                    <button onClick={() => indexContext.setIsPhotoModal!(!indexContext.isPhotoModal)}>upload image</button>
